          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-8">
            ...
            <div className="md:col-span-3 lg:pl-10">
              ...
              <ul className="flex flex-col gap-4 text-base text-gray-600 dark:text-gray-400">
                <li><a href="/" className="hover:text-[#122C93] dark:hover:text-white transition-colors">{language === 'id' ? 'Beranda' : 'Home'}</a></li>
                <li><a href="#fitur" className="hover:text-[#122C93] dark:hover:text-white transition-colors">{language === 'id' ? 'Fitur Utama' : 'Core Features'}</a></li>
                <li><a href="#shift" className="hover:text-[#122C93] dark:hover:text-white transition-colors">Web Dashboard</a></li>
                <li><a href="#recognition" className="hover:text-[#122C93] dark:hover:text-white transition-colors">Mobile App</a></li>
                <li><a href="#standard" className="hover:text-[#122C93] dark:hover:text-white transition-colors">{language === 'id' ? 'Standar Kelas Dunia' : 'World Class Standards'}</a></li>
