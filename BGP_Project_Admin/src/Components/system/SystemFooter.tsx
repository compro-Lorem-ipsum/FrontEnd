...
export const SystemFooter = ({
  copyright = `© 2026 PT Bima Global Security.`,
}: FooterProps) => {
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-8">
            ...
            <div className="md:col-span-5 flex flex-col gap-6">
              <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-[#122C93] dark:text-[#4b6bff] text-xs font-bold tracking-widest uppercase mt-0.5">
                    INDONESIA
                  </span>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 mt-4">
                <a
                  href="https://www.tiktok.com/@bimaglobalsec"
                  target="_blank"
                  rel="noreferrer"
                  className="h-9 w-9 rounded-full bg-gray-100 dark:bg-[#121828] flex items-center justify-center text-gray-600 dark:text-gray-400 hover:bg-[#122C93] dark:hover:bg-[#4b6bff] hover:text-white transition-all duration-300"
                >
            ...
            <div className="md:col-span-3 lg:pl-10">
              <h3 className="text-base font-bold uppercase tracking-wider mb-8 text-gray-900 dark:text-white">
              ...
              <ul className="flex flex-col gap-4 text-base text-gray-600 dark:text-gray-400">
                ...
                <li>
                  <a
                    ...
                    className="hover:text-[#122C93] dark:hover:text-white transition-colors"
                  >
                    {language === "id" ? "Fitur Utama" : "Core Features"}
                  </a>
                </li>
                <li>
                  <a
              ...
              <ul className="flex flex-col gap-6 text-base text-gray-600 dark:text-gray-400">
                <li className="flex items-start gap-4">
                  ...
                  <span className="leading-relaxed pr-4">
                    Jalan Candi Prambanan 770, Kalipancur, Ngaliyan, Semarang,
                    Indonesia
                  </span>
                </li>
